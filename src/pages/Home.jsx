      ...
      <section className="py-32 bg-slate-50" id="places">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <ScrollObserver>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Eng mashhur joylar</h2>
              <div className="w-24 h-1 bg-primary-500 mx-auto rounded-full"></div>
              <p className="mt-4 text-slate-600 max-w-2xl mx-auto">
                O'zbekistonning eng ko'p tashrif buyuriladigan va tarixiy ahamiyatga ega maskanlari bilan tanishing.
              </p>
            </ScrollObserver>
          </div>
          ...
          <div className="text-center mt-16">
            <Link to="/places" className="inline-flex items-center gap-2 text-primary-600 font-semibold hover:text-primary-800 transition-colors text-lg group">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-20">
            ...
            <div className="lg:w-1/2">
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">Biz haqimizda</h2>
              ...
              <div className="grid grid-cols-2 gap-6">
                 ...
                 <div className="border-l-4 border-yellow-500 pl-4">
                    <span className="block text-3xl font-bold text-slate-900">50k+</span>
